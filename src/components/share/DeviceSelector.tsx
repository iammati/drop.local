        ...
        {devices.map((device) => {
          ...
          return (
            <button
              ...
              className={`group flex items-center gap-4 rounded-xl border px-4 py-3.5 text-left transition-all active:scale-[0.99] ${
                isSelected
            ...
            >
              <div className={`flex h-10 w-10 items-center justify-center rounded-lg transition-colors ${
                isSelected ? "bg-foreground" : "bg-accent group-hover:bg-foreground"
              }`}>
                <Icon
